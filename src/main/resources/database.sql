...
CREATE TABLE IF NOT EXISTS `almacen`.`orden` (
  ...
  INDEX `fk_orden_personal1_idx` (`autoriza_id` ASC) ,
  INDEX `fk_orden_personal2_idx` (`comisionado_id` ASC) ,
  ...
  CONSTRAINT `fk_orden_usuario1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orden_personal1`
    FOREIGN KEY (`autoriza_id`)
    REFERENCES `almacen`.`personal` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orden_personal2`
    FOREIGN KEY (`comisionado_id`)
    REFERENCES `almacen`.`personal` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `almacen`.`orden_detalle` (
  ...
  INDEX `fk_orden_detalle_item1_idx` (`item_id` ASC) ,
  CONSTRAINT `fk_orden_detalle_orden1`
    FOREIGN KEY (`orden_id`)
    REFERENCES `almacen`.`orden` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orden_detalle_item1`
    FOREIGN KEY (`item_id`)
    REFERENCES `almacen`.`item` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `almacen`.`autoridad`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `almacen`.`autoridad` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `usuario_id` INT NOT NULL,
  `nombre` VARCHAR(45) NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_autoridades_usuario1_idx` (`usuario_id` ASC) ,
  CONSTRAINT `fk_autoridades_usuario1`
    FOREIGN KEY (`usuario_id`)
    REFERENCES `almacen`.`usuario` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- Table `almacen`.`grupo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `almacen`.`grupo` (
  `id` INT NOT NULL,
  `nombre` VARCHAR(45) NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `almacen`.`grupo_miembro`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `almacen`.`grupo_miembro` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(45) NULL,
  `grupo_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_grupo_miembro_grupo1_idx` (`grupo_id` ASC) ,
  CONSTRAINT `fk_grupo_miembro_grupo1`
    FOREIGN KEY (`grupo_id`)
    REFERENCES `almacen`.`grupo` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `almacen`.`grupo_autoridad`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `almacen`.`grupo_autoridad` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(45) NULL,
  `grupo_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_grupo_autoridad_grupo1_idx` (`grupo_id` ASC) ,
  CONSTRAINT `fk_grupo_autoridad_grupo1`
    FOREIGN KEY (`grupo_id`)
    REFERENCES `almacen`.`grupo` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
