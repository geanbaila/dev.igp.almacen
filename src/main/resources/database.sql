...
CREATE TABLE IF NOT EXISTS `almacen`.`orden` (
  ...
  INDEX `fk_orden_personal1_idx` (`recepciona_id` ASC) ,
  INDEX `fk_orden_personal2_idx` (`recibe_id` ASC) ,
