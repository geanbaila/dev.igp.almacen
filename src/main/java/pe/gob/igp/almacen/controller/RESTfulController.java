...
public class RESTfulController {
    ...
    public List<String> getItem(@PathVariable String codigoPatrimonial) {
        ...
        for(ItemEntity item : eanItem){
            html+="<li onclick=\"addItem('"+item.getId()+"');\">"+item.getCodigoPatrimonial()+"</li>";
        }
        html+= "</ul>";
        ...
        public Map<String,String> getItem(@PathVariable Integer itemId) {
            ...
            String html = "";
            html+= "<tr>";
            html+= "<td>"+item.getId()+"<input type='text' name='item_id[]' value='"+item.getId()+"'/></td>";
